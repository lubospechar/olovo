...
class Location(models.Model):
    ...
    year = SpecialYearField(verbose_name="Rok", help_text="Rok, kdy byla lokalita zaznamenána")
    name = models.CharField(max_length=200, verbose_name="Název lokality", help_text="Zadejte název lokality")
    location_type = models.ForeignKey(LocationType, on_delete=models.CASCADE, verbose_name="Typ lokality", help_text="Vyberte typ lokality")
    point = models.PointField(null=True, blank=True, verbose_name="Bod", help_text="Zadejte souřadnice lokality", srid=4326)
